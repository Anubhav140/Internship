    ...
    <div id="log">
        <div id="form">
            ...
            <form action="${pageContext.request.contextPath}/site" method="post">
                ...
                <input type="text" id="caseID" name="CaseID" value="${param.CaseID}" style="margin-left: 15%; width:25%; height: 30px; border: transparent;"><br><br>
                ...
                <select name="CaseType" id="caseType" style="margin-left: 13%; width:25.8%; height: 30px; border: transparent;">
                    ...
                    <option value="Income Tax" <c:if test="${param.CaseType == 'Income Tax'}">selected</c:if>>Income Tax</option>
                    <option value="ITR" <c:if test="${param.CaseType == 'ITR'}">selected</c:if>>ITR</option>
                    <option value="TT" <c:if test="${param.CaseType == 'TT'}">selected</c:if>>TT</option>
                </select><br><br>

                <label for="description"><b>Case Description:</b></label>
                <textarea name="description" id="description" style="margin-left: 8%; width: 25%; height: 100px; border: transparent;">${param.Description}</textarea><br><br>

                <label for="numFiles"><b>Number Of Documents:</b></label>
                <input type="number" id="numFiles" name="numfiles" value="${param.numfiles}" style="margin-left: 3.6%; width: 25%; height: 30px; border: transparent;"><br><br>
                ...
                <input type="hidden"  name="form" value="updatecase"><br><br>
